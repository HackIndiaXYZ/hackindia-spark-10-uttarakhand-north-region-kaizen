...
wd_path = r"\\172.20.125.61\mtech\Major Jarmal Singh\Data_Demmin_2015_10_01\Data HSI\Smoothed_images\SpectralSubset_west_worked"

# load the Masked Image(Segmented Image)
path_source_image = wd_path + "\Soil_Segmented_image\west_masked.tiff"
...
model_path = r"\\172.20.125.61\mtech\Major Jarmal Singh\SOC Project\Saved_model\Sheet14_382_bands_Denimme_HSI\ENR_model.sav"
...
image_variable = zero_to_20_soc_pred_img
image_name = "zero_to_20_soc_pred_img"


# path to save SOC prediction images
path = wd_path + "\SOC Prediction Image"
