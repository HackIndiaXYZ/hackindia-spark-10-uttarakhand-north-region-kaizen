...
# very good article: https://towardsdatascience.com/partial-least-squares-f4e6714452a#:~:text=PLS%20Discriminant%20analysis%20in%20Python,this%20category%20and%200%20otherwise.
import numpy as np
import pandas as pd
...
# MAnohar uvach band suggestions in which water absorption bands are not there
