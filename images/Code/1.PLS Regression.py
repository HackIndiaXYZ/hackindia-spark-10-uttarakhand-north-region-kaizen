...
filename = r'E:\0.Manoj\7.Project SOC Post Validation facto\Demmin_data.xlsx'
...
mses = []
rpds = []
xticks = np.arange(1, 52)
for n_comp in xticks:
    y_cv, r2, mse, rpd, ME, CCC = optimise_pls_cv(x, y, n_comp)
    r2s.append(r2)
    mses.append(mse)
    rpds.append(rpd)
...
y_cv, r2, rmse, rpd, ME, CCC = optimise_pls_cv(x, y, 8)
print('R2: %0.4f, RMSE: %0.4f, RPD: %0.4f, ME: %0.4f, CCC: %0.4f' %(r2, rmse, rpd, ME, CCC))
# R2: 0.7128, RMSE: 1.8177, RPD: 2.5157, ME: -0.1733, CCC: 0.8320
